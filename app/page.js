  ...
  return (
    <>
      <div className="cont h-[82vh] max-sm:h-[84vh] max-xl:h-[91vh]  overflow-y-scroll overflow-x-hidden">
        <div className="intro text-black flex flex-col justify-center items-center gap-3 py-20  h-fit ">
        ...
        <div className="separation  h-1 bg-slate-200"></div>

        <div className="istpart md:pt-2 md:pb-10 pb-5  h-fit  text-black flex flex-col items-center ">
        ...
        <div className="secondpsrt h-fit  px-5 pb-10">
          <h2 className="text-black text-2xl font-bold text-center py-5">Learn more about us</h2>

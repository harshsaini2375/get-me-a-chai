        ...
        <div className="login h-[80vh]">
            ...
            <div className='Loginpage text-black mx-5 md:mx-0 flex justify-center  h-[45vh]'>
                <div className="border  rounded-md w-full max-w-sm mx-1  p-6 border-black dark:bg-gray-900" id="Login-model">
                    ...
                    <p className="text-2xl font-bold dark:text-black text-center">Login to Continue</p>
                    ...
                    <div className="mt-4">
                        ...
                        <a href="#" className="block">
                            <button onClick={() => { signIn('github') }} className=" w-full text-center py-2 my-3 border flex items-center justify-center border-black rounded-lg bg-white text-slate-700 hover:border-slate-400 hover:text-slate-900 hover:shadow transition duration-150">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" className="w-5 h-5 mr-2 dark:text-black">

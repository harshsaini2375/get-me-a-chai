            ...
            <div className='loginpage text-white mx-5 md:mx-0 flex justify-center  h-[45vh]'>
                <div className="border  rounded-md w-full max-w-sm mx-1  p-6 border-white dark:bg-gray-900" id="login-model">
                    ...
                    <div className="mt-4">
                        ...
                        <a href="#" className="block">
                            <button onClick={() => { signIn('github') }} className=" w-full text-center py-2 my-3 border flex items-center justify-center border-white rounded-lg bg-white text-slate-700 hover:border-slate-400 hover:text-slate-900 hover:shadow transition duration-150">
